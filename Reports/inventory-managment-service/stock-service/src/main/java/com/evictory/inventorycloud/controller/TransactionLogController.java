...
public class TransactionLogController {
	...
	@RequestMapping(value = "/viewCurrentStock/{brandId}/{itemId}/{uomId}", method = RequestMethod.GET)
	public ResponseEntity<?> currentStock(@PathVariable Integer itemId,
										  @PathVariable Integer uomId, @PathVariable Integer brandId) {

		CurrentStock currentStocks = transactionLogService.getCurrentSelected(itemId, uomId, brandId);
